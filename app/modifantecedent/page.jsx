  ...
  return (
    <div className="flex flex-col justify-center min-h-screen">
      ...
      <section className="flex flex-col items-center px-20 pt-10 pb-20 w-full bg-neutral-900 max-md:px-5 flex-grow">
        ...
        <button className="flex justify-center items-center px-4 py-2.5 mt-3 ml-44 max-w-full text-sm font-bold tracking-wide leading-5 text-white rounded-xl bg-zinc-800 w-[480px] max-md:px-5">
